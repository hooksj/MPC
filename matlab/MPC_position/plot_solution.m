...
%     foot4 = plot(P(7,1), P(8,1), 'x');
    ...
    animator = Animation_class([x(1,1);x(6,1)], P(1:2,1), P(3:4,1), P(5:6,1), P(7:8,1));
    ...
    for i = 0.0:0.001:(dt*np)
        ...
        animator.update([T*ax;T*ay], P(1:2,index), P(3:4,index), P(5:6,index), P(7:8,index), ...
                        [C(1,index), C(2,index), C(3,index), C(4,index)])
